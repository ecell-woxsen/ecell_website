            ...
            <div className="flex gap-2.5">
              {Object.entries(siteConfig.social).map(([platform, url]) => (
                <Link
                  ...
                  className="w-9 h-9 border border-[var(--border-g)] rounded-lg flex items-center justify-center font-mono text-[10px] text-white/[0.42] no-underline transition-all duration-200 hover:border-[var(--green-lt)] hover:text-[var(--green-lt)] hover:bg-[rgba(30,107,46,0.1)]"
                >
