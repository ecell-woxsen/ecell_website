    ...
    <section className="section-base bg-[var(--paper)] text-[var(--ink)] py-[110px]" id="contact">
      <div className="grid grid-cols-2 gap-20 items-start max-lg:grid-cols-1 max-lg:gap-12">
          ...
          <div className="flex flex-col gap-3.5">
            {[
              ...
              <div key={info.label} className="flex gap-3.5 items-start">
                <div className="w-9 h-9 border border-[rgba(8,13,28,0.12)] flex items-center justify-center text-[15px] shrink-0">
                  {info.icon}
                </div>
        ...
        <RevealOnScroll delay={2}>
          <div className="bg-[var(--paper2)] border border-[rgba(8,13,28,0.1)] p-11 max-sm:p-5">
            ...
            <form onSubmit={handleSubmit}>
              ...
              <button
                type="submit"
                className="w-full bg-[var(--navy)] text-white py-3.5 font-mono text-[11px] tracking-[0.12em] uppercase border-none transition-colors duration-200 hover:bg-[var(--navy-mid)] mt-2"
              >
                Send Message
              </button>
            </form>
