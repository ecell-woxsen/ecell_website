          ...
          <div ref={gridRef} className="events-grid grid grid-cols-3 gap-5 max-lg:grid-cols-1">
            {previewEvents.map((ev) => {
              ...
              return (
                ...
                >
                  <div className="card-pad group relative flex flex-col justify-between bg-white/[0.02] border border-white/[0.06] hover:border-[var(--green-lt)]/35 rounded-2xl transition-all duration-500 hover:-translate-y-2 hover:shadow-[0_15px_45px_rgba(30,107,46,0.08)] flex-1 overflow-hidden">
                    {/* Hover sweep */}
                    <div className="absolute inset-0 w-[200%] h-full bg-gradient-to-r from-transparent via-white/[0.02] to-transparent -translate-x-full group-hover:animate-sweep pointer-events-none" />
