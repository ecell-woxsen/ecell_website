...
export default function Events() {
  return (
    <section className="section-base bg-[var(--ink)] relative overflow-hidden" id="events">
      ...
      <div className="absolute top-[20%] left-[-10%] w-[400px] h-[400px] rounded-full bg-[rgba(30,107,46,0.04)] blur-[120px] pointer-events-none" />
      <div className="absolute bottom-[20%] right-[-10%] w-[400px] h-[400px] rounded-full bg-[rgba(26,47,94,0.06)] blur-[120px] pointer-events-none" />
          ...
          {events.map((ev, i) => {
            ...
            return (
              <RevealOnScroll
                ...
                className={`flex flex-col ${ev.featured ? "col-span-2 max-lg:col-span-1" : ""}`}
              >
                <div
                ...
                >
                  ...
                  <div>
                    ...
                    {/* Meta info (Location & Date details) */}
                    <div className="flex items-center gap-2 text-[12px] text-white/40 mb-5.5 font-mono tracking-wide">
