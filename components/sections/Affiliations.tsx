        ...
        <div className="grid grid-cols-5 gap-3 mt-14 max-lg:grid-cols-3 max-sm:grid-cols-2">
          {affiliations.map((a) => (
            <RevealOnScroll key={a.id}>
              <div className="bg-[var(--paper2)] border border-[rgba(8,13,28,0.08)] rounded-xl h-[100px] flex items-center justify-center font-['Bebas_Neue',sans-serif] text-[17px] tracking-[0.12em] text-[rgba(8,13,28,0.28)] transition-all duration-300 text-center leading-[1.3] hover:bg-[var(--navy-deep)] hover:text-white/[0.62] px-3">
                {a.name}
              </div>
            </RevealOnScroll>
          ))}
