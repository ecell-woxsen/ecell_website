...
export default function Team() {
  return (
    <section className="section-base bg-[var(--ink2)]" id="team">
      ...
      <div className="grid grid-cols-4 gap-0.5 max-lg:grid-cols-2">
        {teamMembers.map((member, i) => (
          <RevealOnScroll key={member.id} delay={Math.min(i + 1, 4) as 1 | 2 | 3 | 4}>
            <div className="bg-[var(--ink)] border border-[var(--border-g)] overflow-hidden transition-all duration-300 hover:border-[rgba(76,175,98,0.45)] hover:-translate-y-1.5">
              {/* Image placeholder */}
