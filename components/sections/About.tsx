          ...
          <RevealOnScroll delay={2}>
            <div className="flex flex-col">
              {values.map((v) => (
                ...
                >
                  <div className="w-10 h-10 border border-[var(--border-g)] rounded-lg flex items-center justify-center text-base shrink-0 transition-all duration-300 group-hover:border-[var(--green-lt)] group-hover:bg-[rgba(30,107,46,0.12)]">
                    {v.icon}
                  </div>
                  <div>
